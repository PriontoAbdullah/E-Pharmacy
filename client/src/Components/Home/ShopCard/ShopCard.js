            ...
            <div className="cards flex flex-wrap justify-center">
                
                {
                    shopCards.map(shopCard => (
                        ...
                        <div styles={{ 
                            backgroundImage: `url(${shopCard.cardBanner})`,
                            backgroundPosition: 'center center',
                            backgroundSize: 'cover',
                            backgroundRepeat: 'no-repeat'
                            }} class="mx-3 my-8 rounded-lg shadow-xl  p-4 w-96 md:w-2/5 lg:w-1/4 ">

                            

                            
                            <img src={shopCard.cardBanner} alt="" />
                            <div class="relative pt-2">
                                ...
                                <div class="pt-5">
                                    ...
                                    <h1 class="font-bold text-xl pb-1.5">{shopCard.shopName}</h1>
                                    <div class="text-sm">
