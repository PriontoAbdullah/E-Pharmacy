    ...
    return (
        ...
        <div className="flex items-center justify-center w-full col-span-2">
            <form className="max-w-xl p-4 mx-auto mt-4">
                <div className="mb-8 font-serif text-5xl font-bold text-center text-black">Register</div>
                <div className="flex flex-wrap mb-6 -mx-3">
                    <div className="w-full px-3 mb-6 md:w-1/2 md:mb-0">
                        ...
                        <input
                            ...
                            id="grid-first-name" type="text" placeholder="Harsh" required />
                    </div>
                ...
                <div className="flex flex-wrap mb-6 -mx-3">
                    <div className="w-full px-3">
                        ...
                        <input
                            ...
                            type="text" placeholder="HarshDoe" required  />
                    </div>
                </div>
                <div className="flex flex-wrap mb-6 -mx-3">
                    <div className="w-full px-3 mb-6 md:w-1/2 md:mb-0">
                        ...
                        <input
                            ...
                            type="text" placeholder="harshdoe@example.com" required />
                    </div>
                    <div className="w-full px-3 md:w-1/2">
                        <label className="block mb-2 text-xs font-bold tracking-wide text-gray-700 uppercase"
                            for="grid-last-name">
                ...
                <div className="flex justify-center mt-6">
                    <button
                        className="px-8 py-2 font-bold text-white rounded-full shadow-lg bg-gradient-to-r from-pink-500 to-orange-500 hover:from-teal-400 hover:to-blue-500">Register</button>
                </div>
                ...
                <div className="mt-4 flex justify-center inset-x-0.bottom-0">
                    <a href="#" className="text-gray-400 hover:text-gray-500">
                        ...
                        <svg className="self-center w-8 h-8" xmlns="http://www.w3.org/2000/svg"
                    ...
                    <a href="#" className="ml-3 text-gray-400 hover:text-gray-500">
                        ...
                        <svg className="self-center w-8 h-8" xmlns="http://www.w3.org/2000/svg"
                            xlink="http://www.w3.org/1999/xlink" height="20pt" viewBox="0 0 512 512" width="20pt">
