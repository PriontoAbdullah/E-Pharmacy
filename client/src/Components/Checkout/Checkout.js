              ...
              <form>
                <div class="mb-3 pt-0">
                  <input
                    type="text"
                    placeholder="Name"
                    class="px-3 py-3 my-1 border-b border-gray-300 placeholder-gray-500 text-blueGray-600 relative  rounded-lg bg-white  text-sm shadow outline-none focus:outline-none focus:shadow-outline w-full"
                  />
                </div>
                <div class="mb-3 pt-0">
                  <input
              ...
              <div>
                ...
                <label class="inline-flex items-center mt-3">
                  <input
                    ...
                    checked
                  />
                  <span class="ml-2 text-gray-900">Cash On Delivery</span>
                </label>
                <hr />
                <label class="inline-flex items-center mt-3">
                  <input
                    ...
                    class="form-radio h-5 w-5 text-gray-600"
                  />
                  <span class="ml-2 text-gray-900">Bkash</span>
                </label>
              </div>
            </div>
            <div class="lg:px-2 lg:w-1/2">
